      ...
      body: Column(
        children: <Widget>[
          ...
          Row(
            ...
            children: <Widget>[
              _buildButton("7", Colors.blue.shade900, Colors.white),
              _buildButton("8", Colors.blue.shade900, Colors.white),
              _buildButton("9", Colors.blue.shade900, Colors.white),
          ...
          Row(
            mainAxisAlignment: MainAxisAlignment.spaceEvenly,
            children: <Widget>[
              _buildButton("4", Colors.blue.shade900, Colors.white),
              _buildButton("5", Colors.blue.shade900, Colors.white),
              _buildButton("6", Colors.blue.shade900, Colors.white),
              _buildButton("x", Colors.yellow, Colors.black)
            ],
          ),
          Row(
            mainAxisAlignment: MainAxisAlignment.spaceEvenly,
            children: <Widget>[
              _buildButton("1", Colors.blue.shade900, Colors.white),
              _buildButton("2", Colors.blue.shade900, Colors.white),
              _buildButton("3", Colors.blue.shade900, Colors.white),
              _buildButton("-", Colors.yellow, Colors.black)
            ],
          ),
          Row(
            ...
            children: <Widget>[
              _buildButton("=", Colors.yellow, Colors.black),
              _buildButton("0", Colors.blue.shade900, Colors.white),
              _buildButton(".", Colors.blue.shade900, Colors.white),
              _buildButton("+", Colors.yellow, Colors.black)
            ],
          )
        ]
